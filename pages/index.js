    ...
    <div className="max-w-7xl w-full p-6 mx-auto">
      ...
      <div className="max-w-2xl mx-auto">
        <form className="flex items-center">
          ...
          <button type="submit" className="inline-flex items-center py-2.5 px-3 ml-2 text-sm font-medium text-white bg-pink-700 rounded-lg border border-blue-700 hover:bg-pink-800 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-pink-600 dark:hover:bg-pink-700 dark:focus:ring-blue-800"><svg className="mr-2 -ml-1 w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M21 21l-6-6m2-5a7 7 0 11-14 0 7 7 0 0114 0z"></path></svg>Search</button>
        </form>
